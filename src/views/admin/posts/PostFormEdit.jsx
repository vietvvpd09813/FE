...
const PostFormEdit = () => {
  ...
  if (isLoading) {
    return <Spin spinning={true} size="large" tip="Đang tải dữ liệu bài viết..." style={{ width: '100%' }} />;
  }
    ...
    <Spin spinning={submitting} size="large" tip="Đang lưu...">
      <Row justify="center" style={{ width: '100%', margin: 0 }}>
        <Col span={22} style={{ maxWidth: '90vw' }}>
          <Card title="Chỉnh sửa bài viết" bordered={false} style={{ margin: '32px 0', boxShadow: '0 2px 8px #f0f1f2' }}>
            <Form layout="vertical" onFinish={handleSubmit} autoComplete="off">
              ...
              <Form.Item style={{ textAlign: 'right' }}>
                <Button type="button" className="bg-pink-600 hover:bg-pink-700 text-white px-4 py-2 rounded" htmlType="submit" size="large" loading={submitting}>
